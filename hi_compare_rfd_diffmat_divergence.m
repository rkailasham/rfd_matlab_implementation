...
cumul_div=zeros(N,ndim); % the HI block diffusion tensor is 
                         % divergence-free
...
rfd_param=1e-5;
% ntraj_list= [10 20 50 100 2e2 5e2 1e3 2e3 5e3 1e4 2e4 5e4];

ntraj_list= [1e4];


[dat,err_dat] = hi_call_rfd_calc_diff_ens_size(hstar,Q,...
