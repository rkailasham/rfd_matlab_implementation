function [div_v_numeric] = unwrap_div_v_hybrid(v_hat,j,transp_flag,L,M,P,...
    varphi,ndim,Q,normQ,N,del)
...
for r=1:nrow
    [div_v_row_numeric] = unwrap_div_v_rowwise_hybrid(v_hat(r,:),transp_flag,...
