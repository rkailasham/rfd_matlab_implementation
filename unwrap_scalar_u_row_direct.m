function [u_scalar_numeric] = unwrap_scalar_u_row_direct(u_hat_rownum,transp_flag,...
    L,M,P,iv_pf)
...
if(u_hat_rownum(4)==1)
    ratio_seq=cont_prod_inv_series((u_hat_rownum(5)+1),(u_hat_rownum(6)),M);
elseif(u_hat_rownum(4)==2)
    ratio_seq=cont_prod_inv_series((u_hat_rownum(6)),(u_hat_rownum(5)-1),P);
end
